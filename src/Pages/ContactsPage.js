        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'099 481 8455'} text2={'+0427 24924972'} title={'Phone'} />
                    <ContactItem icon={email} text1={'reversato2303@gmail.com'} text2={'+0427 24924972'} title={'Email'} />
